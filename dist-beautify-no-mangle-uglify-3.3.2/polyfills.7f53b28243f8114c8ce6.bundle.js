        ...
        (function(global) {
            !function() {
                ...
                Zone.__load_patch("ZoneAwarePromise", function(global, Zone, api) {
                    ...
                    var symbolState = __symbol__("state"), symbolValue = __symbol__("value"), source = "Promise.then", UNRESOLVED = null, RESOLVED = !0, REJECTED = !1, REJECTED_NO_CATCH = 0;
                    ...
                    }, TYPE_ERROR = "Promise resolved with itself", OBJECT = "object", FUNCTION = "function", CURRENT_TASK_SYMBOL = __symbol__("currentTask");
                        ...
                        return ZoneAwarePromise.toString = function() {
                            ...
                            try {
                                for (var values_2 = __values(values), values_2_1 = values_2.next(); !values_2_1.done; values_2_1 = values_2.next()) {
                                    ...
                                    isThenable(value) || (value = this.resolve(value)), value.then((index = count, function(value) {
                    ...
                    if (NativePromise) {
                        ...
                        typeof fetch_1 == FUNCTION && (global.fetch = (fn = fetch_1, function() {
                ...
                var zoneSymbol = Zone.__symbol__, _global = "object" == typeof window && window || "object" == typeof self && self || global, FUNCTION = "function", UNDEFINED = "undefined", REMOVE_ATTRIBUTE = "removeAttribute";
                ...
                var _defineProperty = Object[zoneSymbol("defineProperty")] = Object.defineProperty, _getOwnPropertyDescriptor = Object[zoneSymbol("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor, _create = Object.create, unconfigurablesKey = zoneSymbol("unconfigurables"), UNDEFINED$1 = "undefined";
                ...
                Zone.__load_patch("util", function(global, Zone, api) {
                    ...
                    !function(window) {
                        ...
                        var openNative = patchMethod(window.XMLHttpRequest.prototype, "open", function() {
                            ...
                            return function(self, args) {
                                var target, task = (target = self, target[XHR_TASK]);
