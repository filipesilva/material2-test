            ...
            !function() {
                ...
                function i(e) {
                    ...
                    if (n) {
                        ...
                        for (r in o) "XMLHttpRequest" === e && "responseBlob" === r || ("function" == typeof o[i = r] ? g[e].prototype[i] = function() {
                            return this[S][i].apply(this[S], arguments);
                        } : Object.defineProperty(g[e].prototype, i, {
                            set: function(t) {
                                "function" == typeof t ? (this[S][i] = Zone.current.wrap(t, e + "." + i), c(this[S][i], t)) : this[S][i] = t;
                            },
                            get: function() {
                                return this[S][i];
                            }
                ...
                Zone.__load_patch("ZoneAwarePromise", function(e, t, n) {
                    ...
                    function u(e, r, o) {
                        ...
                        if (e[k] === b) {
                            var a = null;
                            try {
                                typeof o !== S && typeof o !== D || (a = o && o.then);
                            } catch (t) {
                                return i(function() {
                                    u(e, !1, t);
                                })(), e;
                            }
                            if (r !== T && o instanceof M && o.hasOwnProperty(k) && o.hasOwnProperty(m) && o[k] !== b) s(o), 
                            u(e, o[k], o[m]); else if (r !== T && typeof a === D) try {
                                ...
                                e[k] = r;
                                var f = e[m];
                                e[m] = o, r === T && o instanceof Error && (o[P] = t.currentTask);
                                ...
                                if (0 == f.length && r == T) {
                                    ...
                                    try {
                                        ...
                                        var d = r;
                                        d.rejection = o, d.promise = e, d.zone = t.current, d.task = t.currentTask, h.push(d), 
                                        n.scheduleMicroTask();
                                    }
                                }
                            }
                    ...
                    function l(e, t, n, r, o) {
                        s(e);
                        var c = e[k] ? typeof r === D ? r : i : typeof o === D ? o : a;
                    ...
                    var p = n.symbol, h = [], d = p("Promise"), y = p("then");
                    n.onUnhandledError = function(e) {
                        ...
                        for (;h.length; ) for (var e = function() {
                            var e = h.shift();
                            try {
                    ...
                    var g = p("unhandledPromiseRejectionHandler"), k = p("state"), m = p("value"), _ = "Promise.then", b = null, w = !0, T = !1, E = 0, O = function() {
                        var e = !1;
                        return function(t) {
                            return function() {
                    ...
                    }, x = "Promise resolved with itself", S = "object", D = "function", P = p("currentTask"), j = p("rejectionHandledHandler"), M = function() {
                        function e(t) {
                            if (!(this instanceof e)) throw new Error("Must be an instanceof Promise.");
                            this[k] = b, this[m] = [];
                            try {
                                t && t(c(this, w), c(this, T));
                            } catch (e) {
                                u(this, !1, e);
                            }
                        }
                        return e.toString = function() {
                            ...
                            var r, i, a = new this(function(e, t) {
                                n = function(e, t) {
                            ...
                            try {
                                for (var c = v(e), u = c.next(); !u.done; u = c.next()) {
                                    var s = u.value;
                                    o(s) || (s = this.resolve(s)), s.then((l = i, function(e) {
                                        a[l] = e, --i || t(a);
                                    }), n), i++;
                                }
                            } catch (e) {
                    ...
                    var Z = e[d] = e.Promise, z = t.__symbol__("ZoneAwarePromise"), I = Object.getOwnPropertyDescriptor(e, "Promise");
                    I && !I.configurable || (I && delete I.writable, I && delete I.value, I || (I = {
                        ...
                        t === M ? e[z] = t : (e[d] = t, t.prototype[y] || f(t), n.setNativePromise(t));
                    }, Object.defineProperty(e, "Promise", I)), e.Promise = M;
                    var C = p("thenPatched");
                    if (Z) {
                        f(Z);
                        var R = e.fetch;
                        typeof R == D && (e.fetch = (L = R, function() {
                    ...
                    var L;
                    return Promise[t.__symbol__("uncaughtPromiseErrors")] = h, M;
                });
                ...
                Zone.__load_patch("util", function(e, t, n) {
                    ...
                    var r, o, a = e.XMLHttpRequestEventTarget;
                    a && a.prototype && n.patchEventTarget(e, [ a.prototype ]), i("MutationObserver"), 
                    ...
                    (function(e, t) {
                        if (!w || E) {
                            ...
                            if (function() {
                                ...
                                var o, i = function() {};
                                return (o = new XMLHttpRequest()).onreadystatechange = i, n = o[r] === i, o.onreadystatechange = null, 
                                n;
                            }()) {
                    ...
                    "undefined" != typeof r && r.prototype && r.prototype.toBlob && function(e, t, n) {
                        ...
                        i = a(r.prototype, "toBlob", function(e) {
                            return function(t, n) {
                                ...
                                return a.callbackIndex >= 0 && "function" == typeof n[a.callbackIndex] ? Zone.current.scheduleMacroTask(a.name, n[a.callbackIndex], a, o, null) : e.apply(t, n);
                            };
                        });
                    }();
